...
\begin{center}
\begin{tabular}{ll}
\textbf{Course:} & CSE 565 Software Verification and Validation \\
\textbf{Project:} & Software Unit Testing Framework Project \\
\textbf{Algorithm:} & Heapsort \\
\textbf{Language:} & Python \\
\textbf{Unit Testing Framework:} & Python \texttt{unittest} \\
\end{tabular}
\end{center}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{screenshots/heap_sort.png}
...
I used Python's built-in \texttt{unittest} framework. I chose this framework because it comes with
Python, requires no additional packages, and supports clear assertions for comparing the expected
and actual output of the Heapsort algorithm.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{screenshots/ai_prompt_response.png}
...
I improved the test suite in \texttt{test\_heap\_sort\_student.py}. The student-improved tests kept
the original coverage and added stronger cases.
