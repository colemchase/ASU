...
For Part 1, a Java test harness was used to execute the test cases for \texttt{VendingMachine.java}. The harness calls the \texttt{dispenseItem} method with selected inputs, compares each actual output to the expected output, and prints the total source lines and coverage achieved by the full test suite.
