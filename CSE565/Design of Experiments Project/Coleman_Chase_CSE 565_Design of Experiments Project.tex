...
\begin{lstlisting}[style=code]
% TODO: Paste the exact ChatGPT prompt here after running it.
\end{lstlisting}

\subsection{Generated Test Cases and Evidence}

% TODO: Describe the unedited AI response, save it in a project file, and insert its table or selected rows.
...
\midrule
Test cases generated & 26 & TODO \\
Invalid values & 0 & TODO \\
Duplicate rows & 0 & TODO \\
Required value-pairs & 175 & 175 \\
Pairs covered & 175/175 & TODO \\
Pairwise coverage & 100\% & TODO \\
\bottomrule
\end{tabular}
\end{table}

The PICT suite has already been checked with \texttt{verify\_pairwise\_coverage.py}. It contains 26 valid, non-duplicate test cases and covers all 175 required value-pairs.

% TODO: After validating the AI suite, discuss validity, coverage, suite size, reproducibility, and manual cleanup required.
