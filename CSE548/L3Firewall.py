...
class Firewall(EventMixin):
    ...
    def __init__(self, l2config, l3config):
        ...
        # Store a tuple of MAC pairs which will be installed into the flow table of each switch.
        ...
        with open(l2config, 'r') as rules:
            ...
            for line in csvreader:
                # Read MAC address. Convert string to Ethernet address using EthAddr()
                if line['mac_0'] != 'any':
        ...
        print("L2 disabled pairs:", self.disbaled_MAC_pair)
    ...
    def _handle_ConnectionUp(self, event):
        ...
        for (source, destination) in self.disbaled_MAC_pair:
            ...
            # OpenFlow message. Instructs a switch to install a flow
